...
from validators import PhoneToPersonAssociator, WristDistanceValidator, CentroidMotionTracker
from fence import VirtualFence

if __name__ == "__main__":
    video_source = launch_gui()
    ...
    while True:
        ...
        is_alerting_visually = is_phone_alerting or is_fence_alerting
